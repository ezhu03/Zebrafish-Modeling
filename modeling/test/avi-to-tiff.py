...
def extract_frame(input_path: str, frame_number: int, output_path: str) -> None:
    """
    Extract a specific frame from a video file and save it as a .png in the Downloads folder.
    """
...
if __name__ == "__main__":
    input_path = "/Volumes/Hamilton/Zebrafish/AVI/NoBackup/9.13.23/1fish_group_clear_10-5acc_1fps_FISH1-1_2023-09-13-115253-0000.avi"
    # Convert AVI to MP4
    #avi_to_mp4_ffmpeg(input_path, "/Users/ezhu/Downloads/output_video.mp4")

...
plt.figure(figsize=(5, 4))
plt.hist(data7, bins=30, alpha=0.4, color='blue', label='7 dpf')
plt.hist(data14, bins=30, alpha=0.4, color='purple', label='14 dpf')
plt.hist(data21, bins=30, alpha=0.4, color='red', label='21 dpf')
plt.xlabel('Speed')
...
plt.figure(figsize=(5, 4))
plt.hist(data7b, bins=30, alpha=0.4, color='blue', label='7 dpf')
plt.hist(data14b, bins=30, alpha=0.4, color='purple', label='14 dpf')
plt.hist(data21b, bins=30, alpha=0.4, color='red', label='21 dpf')
plt.xlabel('Speed')
plt.ylabel('Frequency')
plt.legend(title='Blind')
plt.tight_layout()

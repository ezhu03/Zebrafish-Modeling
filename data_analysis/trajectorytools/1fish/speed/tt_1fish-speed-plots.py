...
plt.figure(figsize=(5, 4))
plt.hist(data7, bins=30, alpha=0.4, color='blue', label='7 dpf', weights=np.ones_like(data7) / len(data7) * 100)
plt.hist(data14, bins=30, alpha=0.4, color='purple', label='14 dpf', weights=np.ones_like(data14) / len(data14) * 100)
plt.hist(data21, bins=30, alpha=0.4, color='red', label='21 dpf', weights=np.ones_like(data21) / len(data21) * 100)
plt.xlabel('Speed')
...
plt.figure(figsize=(5, 4))
plt.hist(data7b, bins=30, alpha=0.4, color='blue', label='7 dpf', weights=np.ones_like(data7b) / len(data7b) * 100)
plt.hist(data14b, bins=30, alpha=0.4, color='purple', label='14 dpf', weights=np.ones_like(data14b) / len(data14b) * 100)
plt.hist(data21b, bins=30, alpha=0.4, color='red', label='21 dpf', weights=np.ones_like(data21b) / len(data21b) * 100)
plt.xlabel('Speed')
plt.ylabel('Percentage (%)')
plt.legend(title='Blind')
plt.tight_layout()

...
if x==7 or x==14 or x==21:
    ...
    if x == 7:
        ...
        clear = ["modeling/data/boundary/const3radius0boxradius5iter10fish1_15min_14dpf_clear.npy"]
        if blind == 'Y':
        ...
        sanded = ["modeling/data/boundary/const3radius0boxradius5iter10fish1_15min_14dpf_sanded.npy"]
        if blind == 'Y':
        ...
        half = ["modeling/data/boundary/const3radius0boxradius5iter10fish1_15min_14dpf_half.npy"]
        if blind == 'Y':
        ...
        clear = ["modeling/data/boundary/const3radius0boxradius5iter10fish1_15min_21dpf_clear.npy"]
        if blind == 'Y':
        ...
        sanded = ["modeling/data/boundary/const3radius0boxradius5iter10fish1_15min_21dpf_sanded.npy"]
        if blind == 'Y':
        ...
        half = ["modeling/data/boundary/const3radius0boxradius5iter10fish1_15min_21dpf_half.npy"]
        if blind == 'Y':
...
for i, output in enumerate(outputs):
    vals = -1*output['theta'].dropna().values
    # Flip across the y-axis: θ → π − θ (wrapped to [-π, π])

...
sns.kdeplot(x_sorted, color = colors[0], label='Distribution 1', fill=True,bw_method='scott')
sns.kdeplot(y_sorted, color = colors[1],label='Distribution 2', fill=True,bw_method='scott')

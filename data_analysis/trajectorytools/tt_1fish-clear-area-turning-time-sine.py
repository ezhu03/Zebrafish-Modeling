...
analyzes the turning behavior of the fish near the border of its environment via calculating overall turning times
given a sinusoidal fit for given area bins, plotting the turning time values with respect to reflection area.
'''
import os

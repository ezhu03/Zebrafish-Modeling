...
plt.show()
plt.figure(figsize=(4, 4))
plt.violinplot(p_values, vert=True)
# Customize plot
...
sns.kdeplot(x_sorted, label='Distribution 1', shade=True,bw_method=0.25)
sns.kdeplot(y_sorted, label='Distribution 2', shade=True,bw_method=0.25)
